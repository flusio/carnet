...
Flus se chargera de retrouver les liens correspondants à votre recherche.
...
**Vous pouvez ainsi comprendre toute l’importance qu’il y a à correctement taguer vos liens !**
...
Par exemple, pour retrouver les liens qui parlent de mobile sur ce blog, vous pouvez effectuer la recherche suivante :

```
mobile url: flus.fr
```

Comme ce mot-clé recherche dans n’importe quelle partie de l’URL, vous pouvez retrouver des liens qui pointent vers des fichiers PDF par exemple :
